      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div>
            ...
            <h2 className="text-4xl font-bold text-gray-900 mt-2">Elevated On-Demand Solutions</h2>
          </div>
          <p className="text-gray-500 max-w-sm">Every professional is background checked and trained to deliver the highest standard of service.</p>
        </div>
